        ...
        return `
                <div class="tarea card shadow-1 border-0 mb-4">
                    <div class="card-body tarea-contenedor">
                        <h4 class="tarea-titulo"><b>Pedido:</b>&nbsp;&nbsp; ${tareas.titulo}</h4> <h5><hr></h5><br> 
                        <p> <b>Notas:</b> ${tareas.descripcion} </p>
                        <a data-tarea-id="${tareas.id}" href="#" class="btn btn-link tarea-boton ${tareas.estado ? 'completado-color' : 'text-warning'}">
                            <i data-tarea-id="${tareas.id}" class="fa ${tareas.estado ? 'fa fa-check-square-o' : 'fa-clock-o'} fa-check-circle-o"></i></a>
                        <br>
                        <div>
                            <p> <b>Tipo</b> ${tareas.tipo} </p>
                        </div>    
                    </div>
                </div>
            `
